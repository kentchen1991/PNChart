...
//        NSArray *ylabs =@[@"0星",@"1星",@"2星",@"3星",@"4星",@"5星"];
//        NSArray *xlabs = @[@"1", @"2", @"3", @"4", @"5"];
//        NSArray *data01Array = @[@1,@2,@3,@4,@4];
//        CGFloat ymax = 5;
//        CGFloat ymin = 0;
        NSArray *ylabs =@[@"0",@"20",@"40",@"60",@"80",@"100"];
        NSArray *xlabs = @[@"11", @"12", @"14", @"15", @"16"];
        NSArray *data01Array = @[@60,@65,@66,@80,@100];
        CGFloat ymax = 100;
        CGFloat ymin = 0;
        self.lineChart.yValueMax= ymax;
        self.lineChart.yValueMin = ymin;
        self.lineChart.chartMarginLeft = 35;
        self.lineChart.chartMarginBottom = lineHeight/(ylabs.count + 1);
        self.lineChart.chartCavanHeight = lineHeight - self.lineChart.chartMarginBottom;
        [self.lineChart setYLabels:ylabs];
        [self.lineChart setXLabels:xlabs];
        // Line Chart #1
        //
        ...
        data01.inflexionPointColor = PNRed; //转折点
